...
class TestNoHallucinatedImports:
    ...
    def test_graph_module_imports(self):
        ...
        from imodent.graph.imports import (
            extract_imports,
            ImportInfo,
            resolve_module_name,
        )
    ...
    def test_public_api_surface(self):
        ...
        for name in imodent.__all__:
            assert hasattr(
                imodent, name
            ), f"__all__ claims '{name}' but it doesn't exist"
...
class TestNoHallucinatedMethods:
    ...
    def test_strategy_registry_methods(self):
        ...
        for method in required:
            assert hasattr(
                StrategyRegistry, method
            ), f"StrategyRegistry missing method: {method}"
    ...
    def test_coordinator_methods(self):
        ...
        for method in required:
            assert hasattr(
                AnalysisCoordinator, method
            ), f"Coordinator missing: {method}"
    ...
    def test_finding_factory_method(self):
        ...
        f = Finding.create(
            type="test", severity=Severity.INFO, file=Path("/tmp/x.py"), message="test"
        )
